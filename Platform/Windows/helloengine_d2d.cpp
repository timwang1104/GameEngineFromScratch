...
ID2D1SolidColorBrush *pCornflowerBlushBrush = nullptr;
...
HRESULT CreateGraphicsResource(HWND hWnd)
{
    ...
    if(pRenderTarget == nullptr)
    {
        ...
        if (SUCCEEDED(hr))
        {
            hr = pRenderTarget->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::CornflowerBlue), &pCornflowerBlushBrush);
        }
    }
    return hr;
}
...
void DiscardGraphicsResources()
{
    ...
    SafeRelease(&pCornflowerBlushBrush);
}
    ...
    switch(message)
    {
        ...
        case WM_PAINT:
        {
            ...
            if(SUCCEEDED(hr))
            {
                ...
                pRenderTarget->DrawRectangle(&rectangle2, pCornflowerBlushBrush);
